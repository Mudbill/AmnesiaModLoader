...
public class PreferencesOSX extends Dialog {
	 ...
	 * @param style
	 */
	public PreferencesOSX(Shell parent, int style) {
		super(parent, style);
	}
	...
	private void createContents() {
		...
		labelVer.setText("Version " + MainFrameOSX.getVersion());
		...
		ScrolledComposite scrolledComposite = new ScrolledComposite(panelAbout, SWT.V_SCROLL);
		scrolledComposite.setExpandVertical(true);
		scrolledComposite.setExpandHorizontal(true);
		scrolledComposite.setBounds(10, 42, 494, 271);
		
		ShellAboutOSX shellAbout = new ShellAboutOSX(scrolledComposite, SWT.NONE);
		...
		itemTwitter.setImage(SWTResourceManager.getImage(PreferencesOSX.class, "/resources/icon_twitter.png"));
		...
		itemYoutube.setImage(SWTResourceManager.getImage(PreferencesOSX.class, "/resources/icon_youtube.png"));
	...
	{
		if(MainFrameOSX.getModDirectory() != null) {
			...
			MainFrameOSX.setUseSteam(buttonUseSteam.getSelection());
			MainFrameOSX.setModDirectory(modDir);
			MainFrameOSX.setGameDirectory(gameDir);
			MainFrameOSX.setWarnExec(checkWarnCustomExec.getSelection());
			MainFrameOSX.setWarnShader(checkWarnShaders.getSelection());
			MainFrameOSX.setWarnSteam(checkWarnSteam.getSelection());
