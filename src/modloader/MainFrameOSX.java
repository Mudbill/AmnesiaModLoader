...
public class MainFrameOSX {
	
	private final static String appName = "Amnesia Modloader";
	private final static String appVersion = "1.6.2";
	...
	public static String getVersion() {
		return MainFrameOSX.appVersion;
	}
	
	public static String getModDirectory() {
		if(useSameDir) return MainFrameOSX.gameDirectory;
		else return MainFrameOSX.modDirectory;
	}
	
	public static String getGameDirectory() {
		return MainFrameOSX.gameDirectory;
	}
		
	public static Composite getModPanel() {
		return MainFrameOSX.leftPanel;
	}
	...
	public static void setUseSteam(boolean var) {
		if(var && (MainFrameOSX.getShell() != null)) tableMods.setMenu(menuList2);
		else if(!var && (MainFrameOSX.getShell() != null)) tableMods.setMenu(menuList);
		useSteam = var;
	}
	...
	protected void createContents() {
		...
		if(CurrentOS.getSystem() == "MacOS") {
			try {
				...
				if (view != null) {
					...
					Object /*NSWindow*/ nswindow = c.getDeclaredMethod("window").invoke(view);
		...
		shell.setImage(SWTResourceManager.getImage(MainFrameOSX.class, "/resources/icon_application.png"));
		shell.setBackgroundImage(SWTResourceManager.getImage(MainFrameOSX.class, "/resources/modloader_bg.png"));
		...
		buttonRefresh.setImage(SWTResourceManager.getImage(MainFrameOSX.class, "/resources/icon_refresh.png"));
		...
		menuItemLauncher.setImage(SWTResourceManager.getImage(MainFrameOSX.class, "/resources/icon_launcher.png"));
		...
		menuItemGame.setImage(SWTResourceManager.getImage(MainFrameOSX.class, "/resources/icon_game.png"));
	...
	private static void menuCreator(Menu menu) {
		...
		launcher.setImage(SWTResourceManager.getImage(MainFrameOSX.class, "/resources/icon_launcher.png"));
		...
		amnesia.setImage(SWTResourceManager.getImage(MainFrameOSX.class, "/resources/icon_game.png"));
